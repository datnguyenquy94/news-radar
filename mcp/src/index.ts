...
const REPORT_LABELS: Record<string, string> = {
  ...
  "ai-ph": "Product Hunt AI Products (VI)",
  "ai-ph-en": "Product Hunt AI Products (EN)",
  "ai-arxiv": "ArXiv AI Research (VI)",
  "ai-arxiv-en": "ArXiv AI Research (EN)",
  "ai-hf": "Hugging Face Trending Models (VI)",
  "ai-hf-en": "Hugging Face Trending Models (EN)",
  "ai-community": "Tech Community AI (VI)",
  "ai-community-en": "Tech Community AI (EN)",
  "fin-macro": "Macro Market Dashboard (VI)",
  "fin-macro-en": "Macro Market Dashboard (EN)",
  "fin-vnmacro": "Vietnam Macro Market Dashboard (VI)",
  "fin-vnmacro-en": "Vietnam Macro Market Dashboard (EN)",
  "fin-vnrates": "Vietnam Interest Rate Macro Dashboard (VI)",
  "fin-vnrates-en": "Vietnam Interest Rate Macro Dashboard (EN)",
